...
namespace Framework
{
    ...
    public:
        ...
        static AC_RET create(Utils::JsonTree *data);
        ...
        static AC_RET set(const char *url, Utils::JsonTree *data);

        static AC_RET set(const char *url, char *data);

        static AC_RET get(const char *url, Utils::JsonTree *data);

        static AC_RET get(const char *url, char *data, uint32_t len);

        static AC_RET add(const char *url, Utils::JsonTree *data);
        ...
        static Utils::DataTree *allocNode();

        static void *alloc(uint16_t size);

        static Utils::DataTree *copyTree(Utils::DataTree *src);
