...
Icm20689::Icm20689(DeviceInterface *interface)
{
...
AC_RET Icm20689::readTmp(TmpData &data)
{
    _tmp_mutex.lock();
    data = _tmp_data;
    _tmp_mutex.unlock();
...
AC_RET Icm20689::readGyro(GyroData &data)
{
    _gyro_mutex.lock();
    data = _gyro_data;
    _gyro_mutex.unlock();
...
AC_RET Icm20689::readAcc(AccData &data)
{
    _acc_mutex.lock();
    data = _acc_data;
    _acc_mutex.unlock();
