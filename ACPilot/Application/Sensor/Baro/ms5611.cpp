...
Ms5611::Ms5611(DeviceInterface *interface)
{
...
AC_RET Ms5611::getTemperature(BaroData& data)
{
    uint8_t buf[3] = {0};
...
AC_RET Ms5611::getPressure(BaroData& data)
{
    uint8_t buf[3] = {0};
...
AC_RET Ms5611::getAltitude(BaroData& data)
{
    getTemperature(data);
    getPressure(data);
...
{
    _interface->writeBytes(address, length, value);
}
