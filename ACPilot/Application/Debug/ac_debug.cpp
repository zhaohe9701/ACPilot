...
Utils::Mailbox<ComMessage> *Debug::_mail;
Utils::MemoryPool *Debug::_buffer_pool;

AC_RET Debug::init()
{
    _mail = Utils::Mailbox<ComMessage>::find("send");
    _buffer_pool = Utils::MemoryPool::find("message");
    return AC_OK;
}
